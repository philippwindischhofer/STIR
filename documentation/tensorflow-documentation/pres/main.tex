...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \only<1>{\includegraphics[width = 0.9\textwidth]{../RMPointsLOR.pdf}}
    \only<2>{\includegraphics[width = 0.9\textwidth]{../RMPointsTOR.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \only<1>{\includegraphics[width = 0.9\textwidth]{../RayMarchingStep0.pdf}}
    \only<2>{\includegraphics[width = 0.9\textwidth]{../RayMarchingStep1.pdf}}
    \only<3>{\includegraphics[width = 0.9\textwidth]{../RayMarchingStep2.pdf}}
    \only<4>{\includegraphics[width = 0.9\textwidth]{../RayMarchingStep3.pdf}}
    \only<5>{\includegraphics[width = 0.9\textwidth]{../RayMarchingStep4.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
    ...
    \subfloat[][]{\includegraphics[height = 0.55\textwidth]{../Siddon_CPU.png}\label{2its}}
    \caption{\textbf{left}: 3 iterations, 2LORs per matrix element, \textbf{right}: original STIR}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
    ...
    \subfloat[][]{\includegraphics[height = 0.55\textwidth]{../Siddon_CPU.png}\label{2its}}
    \caption{\textbf{left}: 30 iterations, 2LORs per matrix element, \textbf{right}: original STIR}
  \end{figure}
\end{frame}
