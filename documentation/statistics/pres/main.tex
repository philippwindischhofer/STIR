...
\begin{frame}
  ...
  \begin{figure}
    \centering
      \subfloat[][]{\includegraphics[width = 0.52\textwidth]{../speedup_6_iterations.pdf}\label{6its}}
      \subfloat[][]{\includegraphics[width = 0.52\textwidth]{../speedup_2_iterations.pdf}\label{2its}}
